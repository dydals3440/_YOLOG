...
const SampleBlogs: BlogType[] = [
  {
    ...
    description:
      'An in-depth guide to understanding and creating React components.',
    content: `
  ...
  },
  {
    ...
    description:
      'Learn how to quickly style your web applications using Tailwind CSS.',
    imageUrl:
  ...
  },
  {
    ...
    description:
      'A comprehensive explanation of closures in JavaScript with examples.',
    content: `
  ...
  },
  {
    ...
    description:
      'Get started with Next.js, a powerful React framework for building web applications.',
    content: `
  ...
  },
  {
    ...
    description:
      'Improve your Git skills with these advanced tips and best practices.',
    content: `
